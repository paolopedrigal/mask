...
If a file exports a React component (e.g. `.jsx` or `.tsx` files), then it follows Pascal case conventions. Otherwise, the file will be in kebab case.

#### Imports

Imports are ordered alphabetically. Note: paths prefixed by `.` and `@` are ordered first before alphabetic letters.
